...
PDF状态：本机下载直链返回不可读小文件；仓库已有早期PDF `papers/reading/05-frontier-reflectance-imaging/22-Multispectral_RTI_Framework/22-Multispectral_RTI_Framework.pdf`，本笔记作为补充阅读记录。
