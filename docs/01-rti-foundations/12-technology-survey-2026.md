...
- `papers/reading/02-heritage-epigraphy-cases/23-RTI_Heritage_Timbers/23-RTI_Heritage_Timbers.pdf`
- `papers/reading/02-heritage-epigraphy-cases/23-RTI_Heritage_Timbers/28-RTI_Heritage_Timbers_note.md`
...
- `papers/reading/02-heritage-epigraphy-cases/29-Virtual_RTI_Cultural_Heritage/29-Virtual_RTI_Cultural_Heritage_note.md`
...
- `papers/reading/05-frontier-reflectance-imaging/33-RTI_Deep_Learning_Textile_Clustering/32-RTI_Deep_Learning_Textile_Clustering_note.md`
...
- `papers/reading/04-photometric-stereo/09-Photometric_Stereo_3D_Reconstruction_Artworks/26-Photometric_Stereo_3D_Reconstruction_Artworks_note.md`
- `papers/reading/05-frontier-reflectance-imaging/30-Quantitative_RTI_Profilometry/30-Quantitative_RTI_Profilometry_note.md`
...
- `papers/reading/05-frontier-reflectance-imaging/22-Multispectral_RTI_Framework/31-Multispectral_RTI_Framework_note.md`
...
- `papers/reading/06-ai-annotation-line-drawing/24-Han_Portrait_Stone_YOLOv5/23-Han_Portrait_Stone_YOLOv5_note.md`
...
这与本项目`docs/04-han-stone-ai/10-iiml-knowledge-base.md`和`docs/04-han-stone-ai/iiml-jsonld.schema.json`一致，但后续需要补充解释层级、证据资源、研究者和模型来源字段。

参考：

- `papers/reading/06-ai-annotation-line-drawing/35-ICON_Ontology_Iconology/36-ICON_Ontology_Iconology_note.md`
- `docs/04-han-stone-ai/10-iiml-knowledge-base.md`
